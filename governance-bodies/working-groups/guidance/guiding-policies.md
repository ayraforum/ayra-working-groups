...
* or on [GitHub issues](https://github.com/orgs/ayraforum/repositories). The public is invited to review, discuss and contribute to this work.
...
If changes to this boilerplate are made, the Board may ask for explanation before the ratification vote. Text is drawn from the W3C charter template[\*](guiding-policies.md#w3c-working-group-charter-template).
